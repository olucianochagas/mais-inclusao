...
[![Status](https://img.shields.io/badge/status-pre--alpha-orange.svg)](#estado-atual)
[![License: ISC](https://img.shields.io/github/license/olucianochagas/mais-inclusao?label=license&color=blue)](./LICENSE)
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](./CODE-OF-CONDUCT.md)
[![Conventional Commits](https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg)](https://www.conventionalcommits.org/)
[![DCO](https://img.shields.io/badge/DCO-signed--off-success.svg)](./CONTRIBUTING.md#padrões-de-commit-conventional-commits--dco)
[![Changesets](https://img.shields.io/badge/maintained%20with-changesets-176de4.svg)](https://github.com/changesets/changesets)
[![SemVer](https://img.shields.io/badge/semver-2.0.0-orange.svg?logo=semver)](https://semver.org/)
[![Keep a Changelog](https://img.shields.io/badge/Keep%20a%20Changelog-1.1.0-E05735.svg)](./CHANGELOG.md)

<!-- ─── Compromissos sociais & legais ────────────────────────────── -->

[![WCAG 2.2 AA](https://img.shields.io/badge/WCAG-2.2%20AA-1A6EAF.svg)](#acessibilidade)
[![LGPD](https://img.shields.io/badge/LGPD-Conforme-2d6a4f.svg)](./SECURITY.md#privacidade-e-lgpd)
[![ROPA](https://img.shields.io/badge/ROPA-versionado-2d6a4f.svg)](./docs/legal/ropa.md)
[![Code of Conduct](https://img.shields.io/badge/Code%20of%20Conduct-+Inclus%C3%A3o-7B61FF.svg)](./CODE-OF-CONDUCT.md)

<!-- ─── Stack técnica ────────────────────────────────────────────── -->

[![Node.js](https://img.shields.io/badge/node-%5E24.15.0-339933.svg?logo=node.js&logoColor=white)](.nvmrc)
[![pnpm](https://img.shields.io/badge/pnpm-11.1.2-F69220.svg?logo=pnpm&logoColor=white)](https://pnpm.io)
...
[![Rspack](https://img.shields.io/badge/Rspack-1.x-FF6A33.svg)](https://rspack.dev/)
[![Module Federation](https://img.shields.io/badge/Module%20Federation-2.0-2F2F2F.svg)](https://module-federation.io/)
...
[![Turborepo](https://img.shields.io/badge/Turborepo-2.9-EF4444.svg?logo=turborepo&logoColor=white)](https://turbo.build/)
[![Docker](https://img.shields.io/badge/Docker-dev--container-2496ED.svg?logo=docker&logoColor=white)](./docs/adr/0010-dev-container-purista.md)

<!-- ─── CI & automação (ativam ao primeiro run dos workflows) ────── -->

[![CI](https://img.shields.io/github/actions/workflow/status/olucianochagas/mais-inclusao/ci.yml?branch=main&label=CI&logo=github)](https://github.com/olucianochagas/mais-inclusao/actions/workflows/ci.yml)
[![CodeQL](https://img.shields.io/github/actions/workflow/status/olucianochagas/mais-inclusao/codeql.yml?branch=main&label=CodeQL&logo=github)](https://github.com/olucianochagas/mais-inclusao/actions/workflows/codeql.yml)
[![E2E](https://img.shields.io/github/actions/workflow/status/olucianochagas/mais-inclusao/e2e.yml?branch=main&label=E2E&logo=playwright)](https://github.com/olucianochagas/mais-inclusao/actions/workflows/e2e.yml)
[![Dependabot enabled](https://img.shields.io/badge/Dependabot-enabled-025E8C.svg?logo=dependabot)](./.github/dependabot.yml)
[![Linter: ESLint](https://img.shields.io/badge/lint-ESLint-4B32C3.svg?logo=eslint&logoColor=white)](https://eslint.org/)
[![Formatter: Prettier](https://img.shields.io/badge/format-Prettier-F7B93E.svg?logo=prettier&logoColor=black)](https://prettier.io/)

<!-- ─── Atividade do repositório (live) ──────────────────────────── -->

[![Last commit](https://img.shields.io/github/last-commit/olucianochagas/mais-inclusao?logo=git&logoColor=white)](https://github.com/olucianochagas/mais-inclusao/commits/main)
[![Commit activity](https://img.shields.io/github/commit-activity/m/olucianochagas/mais-inclusao?logo=github)](https://github.com/olucianochagas/mais-inclusao/pulse)
[![Open issues](https://img.shields.io/github/issues/olucianochagas/mais-inclusao?logo=github)](https://github.com/olucianochagas/mais-inclusao/issues)
[![Open PRs](https://img.shields.io/github/issues-pr/olucianochagas/mais-inclusao?logo=github)](https://github.com/olucianochagas/mais-inclusao/pulls)
[![Good first issues](https://img.shields.io/github/issues/olucianochagas/mais-inclusao/good%20first%20issue?label=good%20first%20issue&color=7057ff&logo=github)](https://github.com/olucianochagas/mais-inclusao/labels/good%20first%20issue)
[![Help wanted](https://img.shields.io/github/issues/olucianochagas/mais-inclusao/help%20wanted?label=help%20wanted&color=008672&logo=github)](https://github.com/olucianochagas/mais-inclusao/labels/help%20wanted)
...
flowchart TB
    subgraph Browser["🌐 Navegador"]
        Shell["apps/shell<br/>Host (Module Federation)<br/>Auth · Layout · Theme · Router"]
        Gestor["apps/gestor-mf<br/>(remote MF)"]
        Cidadao["apps/cidadao-mf<br/>(remote MF, light)"]
        Shell -.federation import.-> Gestor
        Shell -.federation import.-> Cidadao
    end

    subgraph BFF["🔌 Backend for Frontend"]
        BFFGestor["bff-gestor<br/>NestJS · 3000"]
        BFFCidadao["bff-cidadao<br/>NestJS · 3001"]
    end

    subgraph Services["⚙️ Serviços de domínio (NestJS + Prisma)"]
        Auth["auth-service<br/>Identity + Tenancy · 3010"]
        Programs["programs-service<br/>Programs + Eligibility · 3020"]
        Citizens["citizens-service<br/>Citizens (light) · 3030"]
        Applications["applications-service<br/>Application Lifecycle · 3040"]
    end

    subgraph DataPlane["🗄 Plano de dados"]
        PG[("PostgreSQL 16<br/>1 schema/serviço")]
        Redis[("Redis 7<br/>sessões · cache · locks")]
        NATS{{"NATS JetStream<br/>event bus interno<br/>+ Outbox pattern"}}
    end

    subgraph Observability["🔭 Observabilidade"]
        OTel["OpenTelemetry SDK"]
        Tempo["Tempo / Jaeger<br/>(tracing)"]
        Pino["Pino → Loki/ELK<br/>(logs)"]
    end

    Gestor -->|REST/JWT| BFFGestor
    Cidadao -->|REST/JWT| BFFCidadao

    BFFGestor --> Auth
    BFFGestor --> Programs
    BFFGestor --> Citizens
    BFFGestor --> Applications
    BFFCidadao --> Auth
    BFFCidadao --> Programs
    BFFCidadao --> Citizens
    BFFCidadao --> Applications
    ...
    Auth -.eventos.-> NATS
    Programs -.eventos.-> NATS
    Citizens -.eventos.-> NATS
    Applications -.eventos.-> NATS
    NATS -.fan-out.-> Applications
    NATS -.fan-out.-> Programs

    Services --> OTel
    OTel --> Tempo
    OTel --> Pino

    classDef frontend fill:#23304a,stroke:#a87dd6,color:#fff
    classDef bff fill:#1f2940,stroke:#6aa6ff,color:#fff
    classDef service fill:#1c2a1f,stroke:#7bd389,color:#fff
    classDef data fill:#1a1a22,stroke:#5b6b8a,color:#fff
    classDef bus fill:#2c2336,stroke:#a87dd6,color:#fff
    classDef obs fill:#3a2a18,stroke:#d0a86b,color:#fff

    class Shell,Gestor,Cidadao frontend
    class BFFGestor,BFFCidadao bff
    class Auth,Programs,Citizens,Applications service
    class PG,Redis data
    class NATS bus
    class OTel,Tempo,Pino obs
```
...
sequenceDiagram
    autonumber
    actor Cidadao as Cidadão (UI)
    participant BFFC as bff-cidadao
    participant Apps as applications-service
    participant NATS as NATS Stream
    participant Notif as Notifications<br/>(Onda 2)

    Cidadao->>BFFC: POST /inscricao
    BFFC->>Apps: POST /applications
    Note over Apps: Tx única:<br/>insert Application(SUBMITTED)<br/>+ insert outbox_event
    Apps->>NATS: applications.application.submitted<br/>(via worker outbox)
    Apps-->>BFFC: 201 Created
    BFFC-->>Cidadao: confirmação

    Note over Apps: ⏰ Mais tarde, gestor decide via UI
    Note over Apps: state IN_TRIAGE → APPROVED → GRANTED
    Apps->>NATS: applications.application.granted
    NATS-->>Notif: fan-out → SMS/email cidadão
```
